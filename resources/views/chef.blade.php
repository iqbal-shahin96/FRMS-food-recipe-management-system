...
<head>
    ...
    <!-- Title -->
    <title>Food & Coocking | OurChefs</title>
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="single-small-receipe-area d-flex">
                                ...
                                <div class="receipe-thumb">
                                    <img src="{{ asset('frontend_theme/img/core-img/chef1.png') }}" style="height:90px; width:100%;" alt="">
                                </div>
                                <!-- Chefe Content -->
                                <div class="receipe-content">
                                    <span>Chef id# {{ $chef->id }}</span>
                                        <h6>Name: {{ $chef->name }}</h6>
                                        <p>Email: {{ $chef->email }}</p>
                                        <p>Phone: {{ $chef->phone }}</p>
                                </div>
                            </div>
                        </div>
                        @endforeach
